  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {showClose && (
          <DialogPrimitive.Close className="ring-offset-background focus-visible:ring-ring text-muted-foreground hover:text-foreground absolute top-4 right-4 rounded-md p-1 opacity-80 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:outline-none disabled:pointer-events-none">
            <X className="size-4" />
